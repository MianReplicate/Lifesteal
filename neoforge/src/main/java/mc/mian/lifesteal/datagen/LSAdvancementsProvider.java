...
public class LSAdvancementsProvider extends AdvancementProvider {
    public LSAdvancementsProvider(List<AdvancementSubProvider.Factory> subProviders) {
        super(subProviders);
    }
    ...
    public static class LSAdvancementsGenerator extends AdvancementSubProvider {

        public LSAdvancementsGenerator(BootstrapContext<Advancement> output){
            super(output);
        }
        ...
        public void generate() {
            AdvancementHolder ROOT = Advancement.Builder.advancement()
                    ...
                    .save(this.output, LSConstants.ROOT.toString());
            Advancement.Builder.advancement()
                    ...
                    .save(this.output, LSConstants.BACK_FROM_THE_DEAD.toString());
            AdvancementHolder CRYSTAL_CORE = Advancement.Builder.advancement()
                    ...
                    .save(this.output, LSConstants.GET_CRYSTAL_CORE.toString());
            AdvancementHolder HEART_CRYSTAL = Advancement.Builder.advancement()
                    ...
                    .save(this.output, LSConstants.GET_HEART_CRYSTAL.toString());
            AdvancementHolder GET_10_MAX_HEARTS = Advancement.Builder.advancement()
                    ...
                    .save(this.output, LSConstants.GET_10_MAX_HEARTS.toString());
            AdvancementHolder REVIVE_CRYSTAL = Advancement.Builder.advancement()
                    ...
                    .rewards(AdvancementRewards.Builder.experience(500))
                    .save(this.output, LSConstants.GET_REVIVE_CRYSTAL.toString());
            Advancement.Builder.advancement()
                    ...
                    .save(this.output, LSConstants.REVIVED.toString());
            Advancement.Builder.advancement()
                    ...
                    .rewards(AdvancementRewards.Builder.experience(500))
                    .save(this.output, LSConstants.USE_TOTEM_WHILE_20_MAX_HEARTS.toString());
            Advancement.Builder.advancement()
                    .parent(GET_10_MAX_HEARTS)
                    ...
                    .addCriterion("has_10_max_hearts", LSAdvancementTrigger.TriggerInstance.GET_10_MAX_HEARTS())
                    .rewards(AdvancementRewards.Builder.experience(500))
                    .save(this.output, LSConstants.GET_10_MAX_HEARTS_WITH_NETHERITE_ARMOR.toString());
        }
    }
}
