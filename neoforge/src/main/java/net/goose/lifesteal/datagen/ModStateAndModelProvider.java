...
public class ModStateAndModelProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        ModelFile deepslate_heart_ore_model = cubeAll(ModBlocks.DEEPSLATE_HEART_ORE.get());
        simpleBlockWithItem(ModBlocks.DEEPSLATE_HEART_ORE.get(), deepslate_heart_ore_model);

        ModelFile heart_ore_model = cubeAll(ModBlocks.HEART_ORE.get());
        simpleBlockWithItem(ModBlocks.HEART_ORE.get(), heart_ore_model);

        ModelFile netherrack_heart_ore_model = cubeAll(ModBlocks.NETHERRACK_HEART_ORE.get());
        simpleBlockWithItem(ModBlocks.NETHERRACK_HEART_ORE.get(), netherrack_heart_ore_model);
