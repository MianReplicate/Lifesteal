...
public class LSConstants {
    ...
    // Lifesteal Data
    public static final Identifier LIFESTEAL_DATA = modLoc("lifesteal_data");
    public static final Identifier HEALTH_DIFFERENCE = modLoc("health_difference");
    public static final Identifier TIME_KILLED = modLoc("time_killed");
    public static final Identifier HEALTH_MODIFIER = modLoc("health_modifier");

    // Loot Tables
    public static final ResourceKey<LootTable> BARREL_1_TABLE =
            createLootTable(Identifier.DEFAULT_NAMESPACE,"chests/barrel_1");
    public static final ResourceKey<LootTable> MINERS_HOME_TABLE =
            createLootTable(Identifier.DEFAULT_NAMESPACE,"chests/miners_home");
    public static final ResourceKey<LootTable> MINERS_RUINED_SHACK_TABLE =
            createLootTable(Identifier.DEFAULT_NAMESPACE,"chests/miners_ruined_shack");
    public static final ResourceKey<LootTable> RICH_CART_TABLE =
            createLootTable(Identifier.DEFAULT_NAMESPACE,"chests/rich_cart");
    public static final ResourceKey<LootTable> RUINED_LIBRARY_TABLE =
            createLootTable(Identifier.DEFAULT_NAMESPACE,"chests/ruined_library");

    // Advancement Triggers (and also used for Advancements themselves lol)
    public static final Identifier GET_10_MAX_HEARTS = modLoc("get_10_max_hearts");
    public static final Identifier USE_TOTEM_WHILE_20_MAX_HEARTS = modLoc("use_totem_while_20_max_hearts");
    public static final Identifier REVIVED = modLoc("revived");
    public static final Identifier BACK_FROM_THE_DEAD = modLoc("back_from_the_dead");

    // Advancements
    public static final Identifier GET_10_MAX_HEARTS_WITH_NETHERITE_ARMOR = modLoc("get_10_max_hearts_with_netherite_armor");
    public static final Identifier GET_REVIVE_CRYSTAL = modLoc("get_revive_crystal");
    public static final Identifier GET_HEART_CRYSTAL = modLoc("get_heart_crystal");
    public static final Identifier GET_CRYSTAL_CORE = modLoc("get_crystal_core");
    ...
    // Biome Modifiers
    public static final Identifier ADD_OVERWORLD_FEATURES = modLoc("add_overworld_features");
    public static final Identifier ADD_NETHER_FEATURES = modLoc("add_nether_features");

    public static Identifier modLoc(String name) {
        return Identifier.fromNamespaceAndPath(LSConstants.MOD_ID, name);
    }
