...
public class HeartCrystalItem extends Item {
    ...
    public boolean useHeartCrystal(ItemStack item, Level level, LivingEntity entity) {
        ...
        if (!level.isClientSide() && entity instanceof ServerPlayer serverPlayer) {
            ...
            boolean rippedHeartCrystal = compoundTag != null && compoundTag.getBoolean(LSConstants.RIPPED);
            boolean unnaturalHeartCrystal = compoundTag != null && compoundTag.getBoolean(LSConstants.UNFRESH);
            success.set(true);
