...
public class ModPlacedFeaturesProvider {
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, ModResources.DEEPSLATE_HEART_GEODE_PLACED, configuredFeatures.getOrThrow(ModResources.DEEPSLATE_HEART_GEODE_CONFIGURED),
                List.of(RarityFilter.onAverageOnceEvery(50), InSquarePlacement.spread(),
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-45), VerticalAnchor.absolute(0)),
                        BiomeFilter.biome()));
        register(context, ModResources.HEART_ORE_PLACED, configuredFeatures.getOrThrow(ModResources.HEART_ORE_CONFIGURED),
                List.copyOf(
                        commonOrePlacement(6,
                                HeightRangePlacement.triangle(VerticalAnchor.absolute(-50), VerticalAnchor.absolute(70)))));
        register(context, ModResources.NETHER_HEART_GEODE_PLACED, configuredFeatures.getOrThrow(ModResources.NETHER_HEART_GEODE_CONFIGURED),
                List.of(RarityFilter.onAverageOnceEvery(30), InSquarePlacement.spread(),
                        ...
                        BiomeFilter.biome()));
        register(context, ModResources.NETHER_HEART_ORE_PLACED, configuredFeatures.getOrThrow(ModResources.NETHER_HEART_ORE_CONFIGURED),
                List.copyOf(
                        commonOrePlacement(6,
